...
\remark{Describe QMR results here.}
...
\end{minipage}
\caption{Performance of a QMR-DT model. \emph{(Left)} ELBo optimization progress during training. \emph{(Right)} Negative log-likelihood of reconstructions.~\remark{Improve this caption}}
