...
In this example and the one that follows, \ic{nnevalModel} evaluate a neural network while also placing an improper uniform prior over the network parameters. This allows neural networks to be used as part of learnable models.
