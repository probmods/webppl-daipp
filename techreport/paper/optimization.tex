...
%% \paul{are magnitude and direction reversed in the intuition above?}
...
%% \paul{above we start equating not-reparameterized with discrete and
%%   reparameterized with continuous, and then (mostly) use
%%   discrete/continuous throughout. i can see the appeal in doing this
%%   (particularly in the main body, perhaps less so in the proofs), but
%%   i wonder if we might call out that these things only roughly line
%%   up, at least in webppl? i know i've confused at least one person
%%   before by not making this clear.}
