...
When $\log \dataMarginal$ can include unnormalized factors (as in our implementation), this is more properly called the variational free energy.
...
\remark{remove this last sentence once the improper prior model learning stuff is done.}
