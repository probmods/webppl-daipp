...
\ndg{mention that technically we are using the free energy, because we allow unnormalized factors?}
...
\end{align}
%%%
\ndg{FIXME: $\gradparamsTheta$ should be theta subscript. (where is this defined in source files?)}
