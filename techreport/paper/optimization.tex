...
\item{Factor $\gradparams \log \guide(\xformedVars | \observedVars)$ and remove terms corresponding to discrete (i.e. non-reparameterized) choices, since, as noted above, they have zero expectation}
\end{enumerate}
%%%
...
\begin{split}
\gradparams \elbo =
\expect_\reparamDist [ \hspace{0.5em} &\sum_{i \in \mathcal{D}} \gradparams \log \reparamDist(\reparamVar_i | \reparamVars_{<i}) ( w_i(\reparamVars, \observedVars) - b_i ) \\
