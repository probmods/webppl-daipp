...
\ndg{possibly leave out the RNN guides for now, until we understand them better. just do mean-field and joint-prediction guides (the latter using val2vec and such)...}
