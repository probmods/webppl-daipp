...
\remark{Should we switch all math to deal with distributions with arbitrary (i.e. non-evidence-based) partition functions?}
...
We also provide options for automatically-defined guide architectures: either mean-field, or a family of architectures that attempts to capture posterior dependencies using recurrent neural networks.~\remark{Statement about what experiments/evaluations we do.}
