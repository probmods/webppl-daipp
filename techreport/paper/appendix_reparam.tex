...
%% \paul{should we say something like `not reparameterized in webppl'
%%   rather than `not reparameterizable'?}

%% \paul{should we mention that we use LogitNormal with Uniform because
%%   we want something that is `shapable', not because it can't be
%%   reparameterized? or just leave it out?}
