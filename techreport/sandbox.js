...
// 	optimize_logProgressFilename: __dirname + '/vae_elboProgress_z20_adam0001.csv',
// 	optimize_checkpointParams: true,
// 	optimize_checkpointParamsFilename: __dirname + '/vae_params_z20_adam0001.json',
...
if (ret.vaeEncodeDecodeSamples) {
	ret.vaeEncodeDecodeSamples.forEach(function(targetGroup, i) {
		misc.saveTensorToGrayscaleImage(targetGroup.target, 28, 28,
			__dirname + '/vae_encodeDecode_target_' + misc.zeropad(i, 3) + '.png', function() {
